...
<aside class="hidden md:flex flex-col w-64 h-screen bg-neutral-900 border-r border-white/5 sticky top-0 shrink-0 z-[1001]">
  ...
  <nav class="flex-1 px-4 space-y-2 mt-4">
    ...
    {:else}
      ...
      <a
        href="/yaml-creator"
        class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 {pathname === '/yaml-creator' ? 'bg-orange-500/10 text-orange-500 shadow-inner shadow-orange-500/5' : 'text-neutral-400 hover:text-white hover:bg-white/5'}"
      >
