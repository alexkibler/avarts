...
<div class="fixed bottom-0 left-0 right-0 z-[1000] border-t border-white/10 bg-neutral-900/80 backdrop-blur-md px-4 pb-safe pt-2 md:hidden">
  <div class="mx-auto flex max-w-lg items-center justify-around">
    {#if isGamePage}
      <!-- Game Mode Navigation -->
      <a href="/" class="flex flex-col items-center gap-1 p-2 text-neutral-400 transition-colors hover:text-orange-500">
      ...
      <button
        ...
        class="flex flex-col items-center gap-1 p-2 transition-colors {$activeGameTab === 'chat' ? 'text-orange-500' : 'text-neutral-400 hover:text-orange-500'}"
      >
      ...
      <button
        ...
        class="flex flex-col items-center gap-1 p-2 transition-colors {$activeGameTab === 'upload' ? 'text-orange-500' : 'text-neutral-400 hover:text-orange-500'}"
      >
      ...
      <button
        ...
        class="flex flex-col items-center gap-1 p-2 transition-colors {$activeGameTab === 'route' ? 'text-orange-500' : 'text-neutral-400 hover:text-orange-500'}"
      >
        ...
        <span class="text-[10px] font-bold uppercase tracking-wider">Routes</span>
      </button>
    {:else}
      <!-- Standard Mode Navigation -->
      <a
        href="/"
        class="flex flex-col items-center gap-1 p-2 transition-colors {pathname === '/' ? 'text-orange-500' : 'text-neutral-400 hover:text-orange-500'}"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
        <span class="text-[10px] font-bold uppercase tracking-wider">Home</span>
      </a>
      ...
      <a
        href="/routes"
        class="flex flex-col items-center gap-1 p-2 transition-colors {pathname === '/routes' ? 'text-orange-500' : 'text-neutral-400 hover:text-orange-500'}"
      >
      ...
      <a
        href="/game"
        class="flex flex-col items-center gap-1 p-2 transition-colors {pathname.startsWith('/game') ? 'text-orange-500' : 'text-neutral-400 hover:text-orange-500'}"
      >
      ...
      <a
        href="/yaml-creator"
        class="flex flex-col items-center gap-1 p-2 transition-colors {pathname === '/yaml-creator' ? 'text-orange-500' : 'text-neutral-400 hover:text-orange-500'}"
      >
