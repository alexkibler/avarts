...
<div class="p-6 text-white max-w-2xl mx-auto">
	<div class="bg-neutral-800 p-6 rounded-lg shadow-lg border border-neutral-700">
		...
		<p class="text-neutral-400 mb-6">
			Create configuration files for your Archipelago multiworld. Download both files and upload
			them to your Archipelago server.
		</p>
		...
		<div class="space-y-6">
			...
			<div class="pt-6 border-t border-neutral-600">
				...
				<p class="text-xs text-neutral-500 mt-4">
					Once your multiworld is running, return to Bikeapelago and connect to it using the "+ New
					Session" button.
				</p>
			</div>
			...
			<div class="pt-6 border-t border-neutral-600 bg-neutral-700/50 p-4 rounded">
				<p class="text-xs text-neutral-400">
					<strong>Note:</strong> This tool generates the configuration files only. To play, you need
					an Archipelago server running with your multiworld.
				</p>
			</div>
		</div>
	</div>
