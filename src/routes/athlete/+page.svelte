...
<div class="w-1/2 mx-auto">
  <div class="flex flex-col">
    ...
    <div class="flex flex-row border-t border-neutral-400 pt-6">
      <div class="w-1/4 text-right text-neutral-400">
      </div>
      <div class="w-3/4 pl-4">
        <form action="/logout" method="POST">
          <button type="submit" class="bg-red-600 hover:bg-red-500 text-white font-semibold px-6 py-2 rounded transition">
            Logout
          </button>
        </form>
      </div>
