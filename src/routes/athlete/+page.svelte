  ...
  <div class="flex flex-col">
    ...
    <div class="flex justify-center my-10">
      <form action="/logout" method="POST">
        <button type="submit" class="bg-neutral-600 hover:bg-orange-600 text-white font-semibold py-2 px-6 rounded-full transition-colors duration-300 flex items-center gap-2">
